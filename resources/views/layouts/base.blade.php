...
<body>
          ...
          <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                ...
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="{{ asset('assets/img/logo.png') }}" height="80" alt="Technology Logo" loading="lazy" />
                    </a>
    ...
    <main>
          <div class="row">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li class="nav-item">
                            <a href="{{route('index')}}" class="nav-link align-middle px-0">
                                <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline text-white">Home</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{route('getProductDetails')}}" class="nav-link px-0 align-middle">
            ...
            <div class="col-auto col-md-9 col-xl-10 bg-secondary-subtle">
                @yield('content')
            </div>
         </div>
    </main>
