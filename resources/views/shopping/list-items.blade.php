                        ...
                        <div class="card ">
                            <div class="d-flex justify-content-between p-3">
                                ...
                                <div class="bg-info rounded-circle d-flex align-items-center justify-content-center shadow-1-strong" style="width: 35px; height: 35px;">
                                    <p class="text-white mb-0 small">{{$item->qty}}x</p>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <span class="small">Smart phones</span>
                                    <p class="small text-danger"><s>{{$item->total}} SAR</s></p>
                                </div>
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">{{$item->description}}</h5>
                                    <h5 class="text-dark mb-0">{{$item->price}} SAR</h5>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                    <p class="text-muted mb-0">Available: <span class="fw-bold">{{$item->qty}}</span></p>
